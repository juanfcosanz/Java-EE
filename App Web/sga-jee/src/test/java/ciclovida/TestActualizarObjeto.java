...
public class TestActualizarObjeto {
	...
	public void testActualizarObjeto() {
		...
		//Paso 5. Incia transacci�n 2
		EntityTransaction tx2 = em.getTransaction();
		tx2.begin();
		
		//Paso 6. Ejecuta SQL (es un select, pero al estar modificado, al terminar la transacci�n har� un update)
		//Como ya tenemos el objeto hacemos solo un merge para resincronizar
		em.merge(persona1);
		
		//Paso 7. Termina transacci�n 2

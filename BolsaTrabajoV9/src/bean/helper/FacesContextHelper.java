...
//clase para eliminar los mensajes indeseados 
public class FacesContextHelper {

	public static void limpiarFacesMessages(FacesContext facesContext,
			String clientId) {
		Iterator<FacesMessage> facesMessags = facesContext
	...
	public static void limpiarImmediateFacesMessages(
